...
function ExpeditionPage.Create(pageTitle, gameScreen)
    ...
    if #s.expeditions > 0 then
        children[#children + 1] = UI.Label { text = "进行中的历练", fontSize = 15, fontColor = Theme.GOLD, marginTop = 4 }
                        ...
                        UI.Panel {
                            ...
                            children = {
                                UI.Panel {
                                    ...
                                    children = {
                                        UI.Label { text = expType.icon, fontSize = 16 },
                                        UI.Label { text = expType.name, fontSize = 14, fontColor = Theme.TEXT_TITLE },
                                    },
                                },
                                UI.Panel {
                                    paddingHorizontal = 8, paddingVertical = 3, borderRadius = 4,
                                    backgroundColor = { 66, 133, 244, 35 },
                                    children = { UI.Label { text = "剩余" .. exp.monthsLeft .. "月", fontSize = 11, fontColor = Theme.BLUE } },
                                },
                            },
                        },
                        UI.Label {
    ...
    -- 派遣新的历练
    children[#children + 1] = UI.Label { text = "选择历练类型", fontSize = 15, fontColor = Theme.GOLD, marginTop = 4 }
    ...
    if #availableMembers == 0 then
        children[#children + 1] = UI.Label { text = "没有可派遣的族人（需年满15岁且在家）", fontSize = 11, fontColor = Theme.TEXT_MUTED }
    end
    ...
    for _, expType in ipairs(GameData.EXPEDITION_TYPES) do
        ...
        children[#children + 1] = UI.Panel {
            ...
            onClick = (not unlocked) and function(self)
                AudioManager.Click()
                ...
                UI.Panel {
                    ...
                    children = {
                        UI.Panel {
                            ...
                            children = {
                                UI.Panel {
                                    ...
                                    children = { UI.Label { text = unlocked and expType.icon or "[锁]", fontSize = 16 } },
                                },
                                UI.Panel {
                                    gap = 2,
                                    children = {
                                        UI.Label { text = expType.name, fontSize = 14, fontColor = unlocked and Theme.TEXT_TITLE or Theme.TEXT_MUTED },
                                        UI.Label {
                        ...
                        unlocked and UI.Panel {
                            ...
                            children = { UI.Label { text = "风险" .. math.floor(expType.riskRate * 100) .. "%", fontSize = 9, fontColor = Theme.RED } },
                        } or nil,
                    },
                },

                -- 描述
                UI.Label { text = expType.desc, fontSize = 11, fontColor = Theme.TEXT_SECONDARY, whiteSpace = "normal" },
                unlocked and UI.Label { text = "奖励：" .. rewardStr, fontSize = 10, fontColor = Theme.GREEN, whiteSpace = "normal" } or nil,
    ...
    children[#children + 1] = UI.Panel {
        ...
        gap = 4,
        children = {
            UI.Label { text = "历练须知", fontSize = 12, fontColor = Theme.BLUE },
            UI.Label {
                text = "· 武艺≥30减少30%风险，武艺≥60再减50%风险\n· 族规「习武自卫」额外降低20%遇险概率\n· 派遣前备好药材，以防族人负伤归来\n· 「深山探秘」风险最高但可获得珍稀物品",
                fontSize = 9, fontColor = Theme.TEXT_SECONDARY, whiteSpace = "normal",
            },
        },
    }
...
function ExpeditionPage.BuildDispatchList(expType, members, canAfford, gameScreen)
    if #members == 0 then
        return UI.Label { text = "无可用族人", fontSize = 10, fontColor = Theme.TEXT_MUTED }
    end
            ...
            children = {
                UI.Panel {
                    ...
                    children = {
                        ...
                        UI.Label { text = "武" .. m.martial .. " 学" .. m.study, fontSize = 10, fontColor = Theme.BLUE },
                    },
                },
                UI.Panel {
                    ...
                    children = { UI.Label { text = "派遣", fontSize = 11, fontColor = enabled and Theme.TEXT_WHITE or Theme.TEXT_MUTED } },
                },
            },
        }
    end
    ...
    if #members > showCount then
        items[#items + 1] = UI.Label { text = "还有" .. (#members - showCount) .. "人可选...", fontSize = 10, fontColor = Theme.TEXT_MUTED }
    end
